class NotInstalled:
    ...
    replace the function/decorator with this object. This allows us to give a friendly
    ...
    def __init__(self, tool, dep):
        ...
        msg += f"pip install memo[{self.dep}]\n\n"
        msg += "See installation guide here: <TODO: LINK>"
        self.msg = msg
